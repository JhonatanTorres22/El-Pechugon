...
if($_POST){
	...
	if(empty($nombre) || empty($categoria_id) || empty($precio) || empty($_FILES['imagen']['name'])){
		...
		if(!move_uploaded_file($_FILES['imagen']['tmp_name'], $destino)){
			...
			$conn->query("INSERT INTO productos (nombre,categoria_id,precio,imagen,activo) VALUES ('{$nombre}','{$categoria_id}','{$precio}','{$imagen}',b'{$activo}')");
			header('Location: productos?msg='.urlencode('Producto creado'));
		}
	}
}
?>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<div class="col-md-4">
					<h5 class="mb-4">Crear producto</h5>
					<?php if(!empty($error)): ?>
					...
					<form method="POST" enctype="multipart/form-data">
						...
						<div class="form-floating mb-3">
							<input type="number" class="form-control" id="precio" name="precio" placeholder="Precio" min="0" step="0.1">
